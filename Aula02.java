...
public class Aula02 extends JPanel {
	...
	public void InicializarComponentes() {
		...
		img1 = new ImageIcon("C:/Users/erikz/Downloads/livro.png");
		lb7 = new JLabel(img1);
		...
		btCal.setBounds(150, 130, 100, 30);

		lbResp.setBounds(10, 170, 400, 25);
		...
		btCal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (mediaFinal >= 6.0) {
					...
					lb8.setVisible(true);
					img2 = new ImageIcon("C:/Users/erikz/Downloads/feliz.png");
					lb8.setIcon(img2);
				}
				if (mediaFinal <= 5.9 && mediaFinal >= 4.0) {
					...
					lb8.setVisible(true);
					img2 = new ImageIcon("C:/Users/erikz/Downloads/confuso.png");
					lb8.setIcon(img2);
				}
				if (mediaFinal <= 3.9) {
					String.valueOf(mediaFinal);
					...
					lb8.setVisible(true);
					img2 = new ImageIcon("C:/Users/erikz/Downloads/triste.png");
					lb8.setIcon(img2);
				}
	...
	public static void main(String args[]) {
		JFrame frame = new JFrame("Boletim Aluno");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().add(new Aula2());
		frame.setBounds(250, 250, 430, 330);
